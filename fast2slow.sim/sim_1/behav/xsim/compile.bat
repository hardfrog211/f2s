...
REM
REM Generated by Vivado on Sun Dec 25 18:04:05 +0800 2022
...
echo "xvlog --incr --relax -prj fast2slow_tb_vlog.prj"
call xvlog  --incr --relax -prj fast2slow_tb_vlog.prj -log xvlog.log
